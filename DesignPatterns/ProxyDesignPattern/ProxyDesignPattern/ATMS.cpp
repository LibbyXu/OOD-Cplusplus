...
void HasCard::getState(){
    std::cout << "Has a card!" << std::endl;
}
...
void HasCorrectPin::getState(){
    std::cout << "Pin code state!" << std::endl;
};
...
void ATMOutOfMoney::getState(){
    std::cout << "Machine out of money!" << std::endl;
};
